"""
Project Description:
- Write a program that checks your internet speeds (up/down). If you're not getting what your internet provider promissed, the program will complain at them with a Tweet.
